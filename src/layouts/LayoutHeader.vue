<template>
  <div>
    ...
    <header
      class="text-slate-700 container mx-auto flex flex-col overflow-hidden px-4 py-4 lg:flex-row lg:items-center sticky">
      <a href="#" class="flex items-center whitespace-nowrap text-5xl font-black font-alpha">
        <!-- <span class="mr-2 w-8">
        <img src="" alt="" />
      </span> -->
        <RouterLink to="/">CINEMA</RouterLink>
      </a>
      ...
      <nav aria-label="Header Navigation"
        ...
        <div class="my-4 flex items-center space-x-6 space-y-2 lg:my-0 lg:ml-auto lg:space-x-8 lg:space-y-0">
          <a href="#" title=""
            ...
            Log in </a>
          <a href="#" title=""
            class=" font-alpha whitespace-nowrap rounded-xl bg-blue-700 px-5 py-3 font-medium text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2 hover:bg-blue-600">COMPRAR
            ENTRADA</a>
        </div>
      </nav>
    </header>
